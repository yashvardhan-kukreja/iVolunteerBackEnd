        ...
        Volunteer.findVolByEmail(email, function(err, volExists){
            if (err){
                ...
                if (!volExists){
                    ...
                    res.json({Success:1, message:"Basic details of the volunteer displayed", firstName: volExists.firstName, lastName: volExists.lastName, coins: volExists.coins, regCount: volExists.registeredevents.length, email:volExists.email, contactinfo: volExists.phonenum});
                }
            }
        });
    });
                                            ...
                                            if (err){
                                                ...
                                                volExists.save(function(err){
                                                    if (err){
                                                        ...
                                                        res.json({Success: 1, message: "Congratulations! You are a part of a good event"});
                                                    }
                                                });
                                            }
                                        });
            ...
            if (err){
                ...
                if (!volunteer){
                    ...
                    if (regArr.length == 0){
                        ...
                        setTimeout(function(){
                            res.json({Success:1, message: "Found the registered events", output: finalArr})}, 500);
                    }
                }
            }
        });
